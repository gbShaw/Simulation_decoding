function [trainedClassifier, validationAccuracy] = CVtrainClassifier(trainingData, responseData)
...
%
%  输入:
%      trainingData: 一个与导入 App 中的矩阵具有相同行数和数据类型的矩阵。
%
%      responseData: 一个与导入 App 中的向量具有相同数据类型的向量。responseData 的
%       长度和 trainingData 的列数必须相等。
%
%  输出:
...
%
% T2 必须是仅包含用于训练的预测变量行的矩阵。有关详细信息，请输入:
%   trainedClassifier.HowToPredict

% 由 MATLAB 于 2022-11-24 15:10:57 自动生成
